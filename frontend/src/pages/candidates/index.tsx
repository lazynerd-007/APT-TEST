...
import InviteCandidate from '../../components/candidates/InviteCandidate';
...
const CandidatesPage = () => {
  ...
  return (
    <DashboardLayout
      ...
      description="Manage and track candidates"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <InviteCandidate onSuccess={() => {
            alert('Candidates invited successfully!');
          }} />
        </div>
        
        <h2 className="text-lg font-medium text-gray-900 mb-4">Candidate List</h2>
